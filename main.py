...
def main():
    ...
    def choose():
        ...
        all_cards.append(card("Wieża", "Groźne arkanum gwałtownej zmiany, chaosu, i zniszczenia. Wieża rażona piorunem oznacza przewrót grzebiący pod gruzami stary porządek i następujące później narodziny nowego ładu. Symbolizuje tragedię, rozpad świata i autodestrukcję.", "TarotCard_17_TheTower.png"))
        ...
        btn_choose = tk.Button(window, text="Wylosuj", command=choose)
        btn_choose.grid(row=2, column=0)
